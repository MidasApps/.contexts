...
Pequeno (~1 kB gzip core), tipado, composável. Inverte a lógica de Redux: muitos stores pequenos e atômicos em vez de um único store gigante. Integra bem com Next.js 16 App Router (`@stacks/frontend/next@16`) e React 19 (`@stacks/frontend/react@19`) desde que respeitada a fronteira client-only.
...
Ver `@stacks/language/typescript@7`.
...
- Tipagem: `@stacks/language/typescript@7`
